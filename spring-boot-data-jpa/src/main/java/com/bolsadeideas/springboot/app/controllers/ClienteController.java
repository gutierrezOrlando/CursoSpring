...
public class ClienteController {
	...
	public String guardar(@Valid Cliente cliente, BindingResult result, Model model, 
		...
		if (!foto.isEmpty()) {
//			aca se guardan las fotos de manera interna en el proyecto
...
//			String rootPath = directorioRecursos.toFile().getAbsolutePath();
			...
			if(cliente.getId() != null 
				...
				Path rootPath = p4.resolve(cliente.getFoto()).toAbsolutePath();
			...
			try {
				...
				Path rutaCompleta = Paths.get(ROOT_PATHTEST + "//" + uniqueFileName);
